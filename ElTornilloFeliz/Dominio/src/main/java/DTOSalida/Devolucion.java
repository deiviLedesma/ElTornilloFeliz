...
public class Devolucion {
     ...
     */
    public Devolucion(String id, String usuario, String motivo, Date fecha, List<CrearItemDevolucion> productosDevueltos) {
        this.id = id;
    ...
    public String toString() {
        return "Devolucion{" + "id=" + id + ", usuario=" + usuario + ", motivo=" + motivo + ", fecha=" + fecha + ", productosDevueltos=" + productosDevueltos + '}';
    }
