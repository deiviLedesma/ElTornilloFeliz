...
public class ItemDevolucionDTO {
     ...
     */
    public ItemDevolucionDTO(String productoId, String nombreProducto, int cantidad, boolean regresarAInventario) {
    ...
    public String toString() {
        return "ItemDevolucionDTO{" + "productoId=" + productoId + ", nombreProducto=" + nombreProducto + ", cantidad=" + cantidad + ", regresarAInventario=" + regresarAInventario + '}';
    }
